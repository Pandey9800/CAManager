...
namespace CAManager
{
    partial class frmInvoice
    {
        ...
        private void InitializeComponent()
        {
			...
			//this.sp_getInvoiceTableAdapter = new CAManager.DataSet1TableAdapters.sp_getInvoiceTableAdapter();
			...
			// 
			// spgetInvoiceBindingSource
			//
			//this.spgetInvoiceBindingSource.DataMember = "sp_getInvoice";
			//this.spgetInvoiceBindingSource.DataSource = this.dataSet1;
			// 
			...
			this.btnDeptSave.Location = new System.Drawing.Point(1009, 25);
			...
			this.btnDeptSave.Text = "Create / Save";
